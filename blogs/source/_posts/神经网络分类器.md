...
tags:
  ...
  - numpy
abbrlink: 81a57a7
date: 2019-07-17 20:25:05
---

参考：

[神经网络推导-矩阵计算](https://www.zhujian.tech/posts/1dd3ebad.html)

[神经网络实现-numpy](https://www.zhujian.tech/posts/ba2ca878.html)

参考[线性SVM分类器](https://www.zhujian.tech/posts/ebe205e.html)实现神经网络分类器

`cs231n assignment2`中实现了自定义层数和数量的神经网络模型，参考其实现完成单个类的神经网络分类器
...
参考[指数计算 - 数值稳定性考虑](https://zhujian.tech/posts/2626bec3.html)，修改代码如下：
...
完整训练和实现代码参考：[cs231n/coding/](https://github.com/zjZSTU/cs231n/tree/master/coding)